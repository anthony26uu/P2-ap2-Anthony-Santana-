...
{
    public partial class ConsultaRetenciones : Form
    {
        public ConsultaRetenciones()
        {
            InitializeComponent();
        }
        ...
        public void SeleccionarOpcionCombo()
        {
            ...
            else
            {
                ...
                {
                    dataGridView1.DataSource = BLL.RetencionesBLL.Lista(p => p.RetencionId == Convert.ToInt32(buscaText.Text));
                }

                else if (comboBox1.SelectedIndex == 1)
                {
                    dataGridView1.DataSource = BLL.RetencionesBLL.Lista(p => p.Descripcion == buscaText.Text);
        ...
        private void ConsultaRetenciones_Load(object sender, EventArgs e)
        {
            Llenar();
        }
